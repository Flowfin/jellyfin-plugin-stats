...
public sealed class AYearReadFromRollupsTests : IDisposable
{
    ...
    public void AYearIsReadAsRollupsAndTwelveWindowsAndNeverAsOneAccountsWholeHistory()
    {
        ...
        AggregateQueries.AYearOver(watched, Ada, 2026, Berlin, topCount: 5);
    ...
    public void EveryFigureOffTheRollupsAgreesWithTheSameFigureOffTheRows()
    {
        ...
        var fromRollups = AggregateQueries.AYearOver(store, Ada, 2026, Berlin, topCount: 5);
    ...
    public void AStoreHoldingRollupsAndNoRowsStillAnswersTheYearAndSaysWhatIsMissing()
    {
        ...
        var year = AggregateQueries.AYearOver(store, Ada, 2026, Berlin, topCount: 5);
    ...
    public void AMonthOverTheBoundCostsItsOwnFiguresAndLeavesTheRestStanding()
    {
        ...
        var year = YearInReview.Over(
            AggregateQueries.RollupsForTheYear(store, Ada, 2026, Berlin),
        ...
        var whole = AggregateQueries.AYearOver(store, Ada, 2026, Berlin, topCount: 5);
    ...
    public void RollupsKeyedInAnotherZoneAreNotReadAsThisYearsDays()
    {
        ...
        Assert.Null(AggregateQueries.RollupsForTheYear(store, Ada, 2026, Auckland));

        var year = AggregateQueries.AYearOver(store, Ada, 2026, Auckland, topCount: 5);
    ...
    public void OneAccountsYearIsFoldedFromTheirOwnRollupsAndNobodyElses()
    {
        ...
        var hers = AggregateQueries.AYearOver(store, Ada, 2026, Berlin, topCount: 5);
        ...
        var handedEverything = YearInReview.Over(
            ...
            (from, to) => AggregateQueries.APlayWindow(store, from, to),
            Ada,
            2026,
            Berlin,
            5,
    ...
    public void AYearWithNothingInItStillSaysSoRatherThanSayingItCouldNotBeComputed()
    {
        ...
        var year = AggregateQueries.AYearOver(store, Ada, 2024, Berlin, topCount: 5);
    ...
    public void AStoreThatHasNeverKeyedARollupOffersNone()
    {
        ...
        Assert.Null(AggregateQueries.RollupsForTheYear(store, Ada, 2026, Berlin));
    ...
    public void AMonthOverTheBoundComesBackAsARefusalCarryingTheBound()
    {
        ...
        var window = AggregateQueries.APlayWindow(store, June(1), June(30));
